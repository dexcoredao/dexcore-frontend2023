...
import NftPools from 'views/NftPools'
import ApplyNft from 'views/ApplyNft'
import StakingModal from 'views/GenNft/StakingModal'
import ViewNFTs from 'views/GenNft/ViewNFTs'
...
const LockupStaking=lazy(() => import('./views/LockupStaking'))
